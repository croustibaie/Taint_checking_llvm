...
To add the Pass to llvm, cp the "insert_fun" repository to ~/your-pass-to-clang/clang-llvm/llvm/lib/Transforms/ 

In ~/your-pass-to-clang/clang-llvm/llvm/lib/Transforms, add "add_subdirectory(insert_fun)".

Compile with ninja.

==========================Compile your source files to bicode=========================
...
opt -load /your-pass-to-llvm/clang-llvm/build/lib/LLVMinsertFun.so -bishe_insert <~/Pass-to-your-bitcode/b.bc> b1.bc
